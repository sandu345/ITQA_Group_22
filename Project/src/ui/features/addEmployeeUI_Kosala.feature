Feature: Employee Management in OrangeHRM
  ...
  Scenario: Add new employee with required fields
    Given I open the login page for add employee
    When I enter username "Admin" and password "admin123" for add employee
    And I click the login button for add employee
    When I navigate to PIM module
    And I click on Add Employee
    And I fill in the required employee details

  Scenario: Save new employee
    When I click the save button for add employee
